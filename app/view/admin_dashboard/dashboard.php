        ...
        <section class="hero">
            <div class="container">
                <form id="search-form" method="POST" action="dashboard.php">
                    <input type="text" name="query" placeholder="Search by Ticket ID..." value="<?php echo htmlspecialchars($searchQuery); ?>" required>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($ticket['ticket_status'] === 'open'): ?>
                                    <button class="modal-button open" onclick="openModal('open', <?php echo $ticket['ticket_id']; ?>)">Open</button>
                                <?php else: ?>
                                    <button class="modal-button resolved" onclick="openModal('resolved', <?php echo $ticket['ticket_id']; ?>)">Resolved</button>
                                <?php endif; ?>
                            </td>
