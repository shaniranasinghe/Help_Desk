        ...
        <?php if (count($tickets) > 0): ?>
            <div class="ticket-grid">
                <?php foreach ($tickets as $ticket): ?>
                    <div class="ticket-card <?php echo $ticket['ticket_status'] === 'open' ? 'open-ticket' : ($ticket['ticket_status'] === 'resolved' ? 'resolved-ticket' : ''); ?>">
                        ...
                        <div class="ticket-footer">
                            <button class="btn view-more" onclick="showDetails(<?php echo htmlspecialchars($ticket['ticket_id']); ?>)">View More</button>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
